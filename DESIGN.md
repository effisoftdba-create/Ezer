...
@font-face {
  font-family: "DM Sans";
  src: url("https://www.guvi.in/assets/fonts/dm-sans/dm-sans-v6-latin-regular.woff2") format("woff2");
  font-weight: 400;
}
@font-face {
  font-family: "DM Sans";
  src: url("https://www.guvi.in/assets/fonts/dm-sans/dm-sans-v6-latin-700.woff2") format("woff2");
  font-weight: 700;
}
@font-face {
  font-family: "Jones";
  src: url("https://www.guvi.in/assets/fonts/jones/Jones-Light-subset.woff2") format("woff2");
  font-weight: 400;
}
@font-face {
  font-family: "Jones";
  src: url("https://www.guvi.in/assets/fonts/jones/Jones-Bold-subset.woff2") format("woff2");
  font-weight: 700;
}
@font-face {
  font-family: "Wanted Sans";
  src: url("https://www.guvi.in/assets/fonts/wanted-sans/WantedSans-Regular-subset.woff2") format("woff2");
  font-weight: 400;
}
@font-face {
  font-family: "Wanted Sans";
  src: url("https://www.guvi.in/assets/fonts/wanted-sans/WantedSans-Bold-subset.woff2") format("woff2");
  font-weight: 700;
}
@font-face {
  font-family: "Inter";
  src: url("https://assets.swipepages.com/fonts/inter/regular/Inter-Regular.woff") format("woff");
  font-weight: 400;
}
@font-face {
  font-family: "Inter";
  src: url("https://assets.swipepages.com/fonts/inter/bold/Inter-Bold.woff") format("woff");
  font-weight: 700;
}
```
