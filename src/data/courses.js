export const phase1Courses = [
  {
    id: "iitd-vlsi-design",
    title: "Digital VLSI Design Programme",
    slug: "iitd-vlsi-design",
    badge: "IIT Delhi & CEP Partnered",
    tagline: "Master RTL-to-GDSII, Physical Design & Low-Power Chip Architecture.",
    description: "Executive certificate programme offered by Continuing Education Programme (CEP), IIT Delhi & HCL GUVI. Build hands-on expertise in RTL-to-GDSII, static timing analysis (STA), physical design, and advanced chip implementation over 6 months.",
    tools: ["Verilog / SystemVerilog", "Linux & TCL Scripting", "Synopsys Design Compiler", "Cadence Innovus / Tempus", "UPF / CPF Low Power", "DFT & ATPG", "AMS / PLL"],
    image: "https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&q=80&w=800&h=600",
    duration: "6 Months",
    schedule: "Sunday, 10:00 AM - 1:00 PM IST (Live Online)",
    startDate: "Next Batch Starting Soon",
    languages: "English",
    fee: "₹1,35,000 + 18% GST",
    applicationFee: "₹1,000 + 18% GST (Non-refundable)",
    
    institutionalRankings: [
      { rank: "#1", title: "QS World University Rankings: India 2026", source: "IIT Delhi" },
      { rank: "#2", title: "NIRF 2025 Engineering Category", source: "IIT Delhi" },
      { rank: "3 Days", title: "On-Campus Immersion at IIT Delhi", source: "Academic & Lab Exposure" },
      { rank: "RTL-to-GDSII", title: "Complete Chip Flow Mastery", source: "Industry Standard" }
    ],

    campusImmersion: {
      title: "3-Day IIT Delhi Campus Immersion",
      highlights: [
        "Three-day hands-on immersion at the prestigious IIT Delhi campus",
        "Direct face-to-face interaction with renowned IIT Delhi faculty members",
        "Peer networking and collaborative project sessions beyond virtual classrooms",
        "Practical reinforcement of advanced microelectronics & nano-scale VLSI concepts"
      ],
      disclaimer: "* Travel and accommodation costs are borne by participants. IIT Delhi CEP oversees academic delivery."
    },

    whoIsItFor: [
      "Working Engineers seeking transition into semiconductor, ASIC & physical design roles",
      "Electronics (ECE), Electrical (EEE), Physics & Computer Science graduates / diploma holders",
      "Fresh graduates aiming to build industry-relevant VLSI expertise in chip design domains",
      "Sysadmins and Hardware Technologists aiming for low-power silicon optimization"
    ],
    ...
    curriculumModules: [
      {
        ...
        topics: ["CMOS ASIC Design Flow", "MOS Device Physics", "CMOS Inverter", "Combinational & Sequential Logic Gates"]
      },
      {
        num: "02",
        title: "Scripting for VLSI Professionals",
        topics: ["Linux & Shell Scripting", "TCL / Perl for EDA Automation", "VLSI Design Flow Integration", "RTL Coding & Design Styles"]
      },
      {
        num: "03",
        title: "Logic Synthesis & STA",
        topics: ["Logic Synthesis Concepts & Optimization", "Static Timing Analysis (STA) & Timing Constraints", "Clock Tree Synthesis Prep", "Power-Aware Synthesis"]
      },
      {
        num: "04",
        title: "Design for Testability (DFT) & Reliability",
        topics: ["Scan Chain Insertion & ATPG", "BIST (Built-in Self Test)", "Fault Models & Coverage Metrics", "Soft Errors & Nano-Scale Reliability"]
      },
      {
        num: "05",
        title: "Physical Design (RTL to GDSII)",
        topics: ["Floorplanning, Placement & Routing", "Clock Tree Synthesis (CTS) & Power Planning", "FinFET 7nm/5nm/3nm Challenges", "EUV Lithography & Double Patterning"]
      },
      {
        num: "06",
        title: "Low Power & Advanced Design Techniques",
        topics: ["Low Power Design Methodologies", "Sources of Dynamic & Static Power Dissipation", "UPF / CPF Power-Aware Specifications", "Power Gating & Voltage Domain Isolation"]
      },
      {
        num: "07",
        title: "Mixed-Signal & AMS Design",
        topics: ["Analog IC Design Fundamentals", "Phase-Locked Loop (PLL) & Clock Generation", "Mixed-Signal ASIC Interfaces", "ADC/DAC Integration"]
      },
      {
        num: "08",
        title: "Packaging & System-in-Package (SiP)",
        topics: ["Advanced Semiconductor Packaging", "Thermal & Power Integrity Analysis", "Signal Integrity in High-Speed ICs", "Heterogeneous Integration"]
      }
    ],

    projects: [
      "Combinational & Sequential CMOS Circuit Design & Simulation",
      "Low Power I/O Transceiver & Level Shifter Circuit Design",
      "Power Management IC (PMIC) Control Architecture Design",
      "Clock Tree Synthesis (CTS) Optimization & High-Frequency STA Timing Closure",
      "Full Design for Test (DFT) & Automatic Test Pattern Generation (ATPG) Implementation"
    ],

    faculty: [
      {
        name: "Prof. Samaresh Das",
        role: "Professor & Head, CARE, IIT Delhi",
        image: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=300&h=300",
        bio: "Professor & Head at Centre for Applied Research in Electronics (CARE), IIT Delhi. Previously worked at Tyndall National Institute (Ireland) and Hitachi Cambridge Lab (UK). Holds UPLG Chair for Future Computing Technologies.",
        tags: ["Nanoelectronics", "Silicon Devices", "Future Computing"]
      },
      {
        name: "Prof. Ankur Gupta",
        role: "Associate Professor, CARE, IIT Delhi",
        image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=300&h=300",
        bio: "Core member of VLSI Design Tools & Technology (VDTT) at IIT Delhi. Over 12 years of academic leadership and 6+ years of industry experience at Intel Inc., Texas Instruments, and Global Foundries.",
        tags: ["VLSI Design", "Intel & TI Veteran", "Microelectronics"]
      },
      {
        name: "Prof. Pushparaj Singh",
        role: "Associate Professor, Microelectronics, IIT Delhi",
        image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=300&h=300",
        bio: "Ph.D. from NTU Singapore. Formerly Research Scientist at A*STAR Institute of Microelectronics Singapore. Specialized in MEMS, non-volatile memories, and junctionless transistor concepts.",
        tags: ["MEMS Sensors", "A*STAR Singapore", "Nano-Devices"]
      },
      {
        name: "Prof. Rahul Mishra",
        role: "Assistant Professor, Nanoelectronics, IIT Delhi",
        image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&q=80&w=300&h=300",
        bio: "Ph.D. from NUS Singapore. Postdoctoral researcher at NUS (2018–2020) and former Component Design Engineer at Intel Corporation, Bangalore. Focuses on Spintronics and Neuromorphic computing.",
        tags: ["Intel Corp", "Spintronics", "Neuromorphic AI"]
      }
    ],

    admissionSteps: [
      { step: "01", title: "Select Programme & Register", desc: "Submit your basic profile and select the Digital VLSI Design Executive Certificate Programme." },
      { step: "02", title: "Advisor Interaction", desc: "Connect with Programme Advisors for personalized eligibility evaluation and submit application fee." },
      { step: "03", title: "Document Verification", desc: "Academic credentials and experience documents are reviewed by the IIT Delhi Programme Coordinator." },
      { step: "04", title: "Offer Letter Rollout", desc: "Receive your official Offer Letter issued by Continuing Education Programme (CEP), IIT Delhi." },
      { step: "05", title: "Seat Confirmation", desc: "Pay the 1st installment fee to lock your seat in the upcoming cohort." },
      { step: "06", title: "Onboarding & Live Classes", desc: "Access the learning management system (LMS), join live Sunday sessions, and begin your journey." }
    ],

    certificateCriteria: {
      participation: {
        title: "Certificate of Participation",
        req: "Minimum 50% live session attendance throughout the 6-month duration.",
        issuer: "Issued by CEP, IIT Delhi (Official E-Certificate)"
      },
      completion: {
        title: "Certificate of Completion",
        req: "Score at least 60% overall in assessments/projects AND maintain 50%+ attendance.",
        issuer: "Issued by CEP, IIT Delhi (Official E-Certificate)"
      }
    },

    comparisonTable: [
      { feature: "Certification Credibility", us: "Official Certificate from CEP, IIT Delhi", others: "Standard unaccredited online certificate" },
      { feature: "Curriculum Scope", us: "Complete RTL-to-GDSII end-to-end chip flow", others: "Isolated tool tutorials without architecture depth" },
      { feature: "Faculty & Mentorship", us: "Live classes directly by IIT Delhi professors & semiconductor veterans", others: "Pre-recorded videos with junior TA support" },
      { feature: "Campus Exposure", us: "3-Day physical immersion at IIT Delhi campus", others: "100% remote with zero academic campus access" },
      { feature: "Placement & Support", us: "1-Year placement guidance & interview preps", others: "Self-serve job board posting only" }
    ],

    installmentSchedule: [
      { stage: "Application Fee", detail: "Paid at time of application", amount: "₹1,000 + GST" },
      { stage: "1st Installment", detail: "Within 1 week of offer rollout", amount: "₹54,000 + GST" },
      { stage: "2nd Installment", detail: "Mid-programme milestone", amount: "₹54,000 + GST" },
      { stage: "3rd Installment", detail: "Final project phase milestone", amount: "₹27,000 + GST" }
    ],

    referralOffer: {
      title: "Refer a Friend & Earn ₹10,000",
      desc: "Refer your colleague or friend to the IIT Delhi Digital VLSI Design Programme and receive a ₹10,000 Amazon Voucher upon successful enrollment."
    },

    outcomes: ["ASIC Design Engineer", "Physical Design (PD) Engineer", "Static Timing Analysis (STA) Engineer", "RTL Verification Engineer", "DFT Engineer"],
    
    faq: [
      { q: "Who offers this programme?", a: "This programme is offered by the Continuing Education Programme (CEP), IIT Delhi." },
      { q: "What is the duration and schedule?", a: "It is a 6-month live online programme with sessions every Sunday from 10:00 AM to 1:00 PM IST." },
      { q: "Who can apply?", a: "Graduates or diploma holders from recognised institutions in ECE, EEE, Physics, CS, or related engineering streams are eligible." },
      { q: "What certificate will I receive?", a: "Participants meeting assessment criteria earn an official Certificate of Completion from CEP, IIT Delhi. Minimum 50% attendance earns a Certificate of Participation." },
      { q: "Is there a campus component?", a: "Yes! A 3-day campus immersion at IIT Delhi is included towards the end of the programme." },
      { q: "What is the refund policy?", a: "An 80% refund (excluding GST) is available if withdrawal is requested within 15 days of the first session." }
    ]
  },
