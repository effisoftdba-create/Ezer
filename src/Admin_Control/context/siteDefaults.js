...
export const defaultHiringPartners = [
  { id: 'partner-1', name: 'TCS Tata', image: 'https://logo.clearbit.com/tcs.com', row: 'Row 1', status: 'Active', website: 'https://www.tcs.com', imagePosition: 'center center', imageFit: 'contain' },
  { id: 'partner-2', name: 'Infosys', image: 'https://logo.clearbit.com/infosys.com', row: 'Row 1', status: 'Active', website: 'https://www.infosys.com', imagePosition: 'center center', imageFit: 'contain' },
  { id: 'partner-3', name: 'Wipro', image: 'https://logo.clearbit.com/wipro.com', row: 'Row 1', status: 'Active', website: 'https://www.wipro.com', imagePosition: 'center center', imageFit: 'contain' },
  { id: 'partner-4', name: 'HCLTech', image: 'https://logo.clearbit.com/hcltech.com', row: 'Row 1', status: 'Active', website: 'https://www.hcltech.com', imagePosition: 'center center', imageFit: 'contain' },
  { id: 'partner-5', name: 'Zoho Corporation', image: 'https://logo.clearbit.com/zoho.com', row: 'Row 1', status: 'Active', website: 'https://www.zoho.com', imagePosition: 'center center', imageFit: 'contain' },
  { id: 'partner-6', name: 'Capgemini', image: 'https://logo.clearbit.com/capgemini.com', row: 'Row 2', status: 'Active', website: 'https://www.capgemini.com', imagePosition: 'center center', imageFit: 'contain' },
  { id: 'partner-7', name: 'Accenture', image: 'https://logo.clearbit.com/accenture.com', row: 'Row 2', status: 'Active', website: 'https://www.accenture.com', imagePosition: 'center center', imageFit: 'contain' },
  { id: 'partner-8', name: 'Cognizant', image: 'https://logo.clearbit.com/cognizant.com', row: 'Row 2', status: 'Active', website: 'https://www.cognizant.com', imagePosition: 'center center', imageFit: 'contain' },
  { id: 'partner-9', name: 'Amazon Web Services', image: 'https://logo.clearbit.com/amazon.com', row: 'Row 2', status: 'Active', website: 'https://aws.amazon.com', imagePosition: 'center center', imageFit: 'contain' },
  { id: 'partner-10', name: 'Google Cloud', image: 'https://logo.clearbit.com/google.com', row: 'Row 2', status: 'Active', website: 'https://cloud.google.com', imagePosition: 'center center', imageFit: 'contain' },
  { id: 'partner-11', name: 'Microsoft Azure', image: 'https://logo.clearbit.com/microsoft.com', row: 'Row 3', status: 'Active', website: 'https://azure.microsoft.com', imagePosition: 'center center', imageFit: 'contain' },
  { id: 'partner-12', name: 'IBM Global', image: 'https://logo.clearbit.com/ibm.com', row: 'Row 3', status: 'Active', website: 'https://www.ibm.com', imagePosition: 'center center', imageFit: 'contain' },
  { id: 'partner-13', name: 'Freshworks', image: 'https://logo.clearbit.com/freshworks.com', row: 'Row 3', status: 'Active', website: 'https://www.freshworks.com', imagePosition: 'center center', imageFit: 'contain' },
  { id: 'partner-14', name: 'L&T Technology Services', image: 'https://logo.clearbit.com/ltts.com', row: 'Row 3', status: 'Active', website: 'https://www.ltts.com', imagePosition: 'center center', imageFit: 'contain' },
  { id: 'partner-15', name: 'Tech Mahindra', image: 'https://logo.clearbit.com/techmahindra.com', row: 'Row 3', status: 'Active', website: 'https://www.techmahindra.com', imagePosition: 'center center', imageFit: 'contain' }
];
