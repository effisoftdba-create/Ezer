...
const slides = [
  {
    url: '/images/hero/hero_students_group.png',
  ...
  {
    url: '/images/hero/hero_devops_lab.png',
  ...
  {
    url: '/images/hero/hero_qa_testing.png',
  ...
  {
    url: '/images/hero/hero_ai_ml_team.png',
    ...
    <section style={{ 
      ...
      <div className="container">
        <div style={{
          ...
          {/* Right Crisp Clear Image Display */}
          <div style={{ 
