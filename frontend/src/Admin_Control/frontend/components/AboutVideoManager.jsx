          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '16px', paddingBottom: '10px', borderBottom: '1px solid #e2e8f0' }}>
              <span style={{ fontSize: '0.78rem', fontWeight: 900, color: '#f2b733', background: '#000648', padding: '4px 12px', borderRadius: '50px', letterSpacing: '0.06em' }}>
                SLOT 0{idx + 1}: {vid.tag || `VIDEO SHOWCASE 0${idx + 1}`}
              </span>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '16px' }}>
              <div>
                <label htmlFor={`vid_tag_${idx}`} style={{ display: 'block', fontSize: '0.8rem', fontWeight: 800, color: '#334155', marginBottom: '4px' }}>
                  Section Badge / Tag *
                </label>
                <input
                  id={`vid_tag_${idx}`}
              ...
              <div>
                <label htmlFor={`vid_url_${idx}`} style={{ display: 'block', fontSize: '0.8rem', fontWeight: 800, color: '#334155', marginBottom: '4px' }}>
            ...
            <div style={{ marginBottom: '16px' }}>
              <label htmlFor={`vid_title_${idx}`} style={{ display: 'block', fontSize: '0.8rem', fontWeight: 800, color: '#334155', marginBottom: '4px' }}>
                Video Section Title *
              </label>
              <input
                id={`vid_title_${idx}`}
            ...
            <div style={{ marginBottom: '20px' }}>
              <label htmlFor={`vid_desc_${idx}`} style={{ display: 'block', fontSize: '0.8rem', fontWeight: 800, color: '#334155', marginBottom: '4px' }}>
            ...
            <div>
              <span style={{ display: 'block', fontSize: '0.75rem', fontWeight: 800, color: '#000648', marginBottom: '8px' }}>
                Live Video Player Preview (Slot 0{idx + 1}):
              </span>
