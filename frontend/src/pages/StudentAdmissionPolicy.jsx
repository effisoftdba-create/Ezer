...
function AdmissionAgreementTab({ onOpenDemoModal }) {
  return (
    <div style={{
      background: '#ffffff', border: '2px solid #000648', borderRadius: '16px',
      padding: 'clamp(16px, 4vw, 36px)', boxShadow: '0 12px 32px rgba(0,6,72,0.08)',
      ...
      <div style={{ textAlign: 'center', borderBottom: '2px solid #000648', paddingBottom: '20px', marginBottom: '24px' }}>
        ...
        <p style={{ fontSize: '0.86rem', color: '#64748b', marginTop: '6px', maxWidth: '600px', margin: '6px auto 0' }}>
      ...
      <div style={{ marginBottom: '24px', background: '#f8fafc', padding: '20px', borderRadius: '12px', border: '1px solid #cbd5e1' }}>
        <h3 style={{ fontSize: '0.96rem', fontWeight: 800, color: '#000648', marginBottom: '10px', textTransform: 'uppercase', letterSpacing: '0.04em' }}>
          Institute Responsibilities
        </h3>
        <ul style={{ display: 'flex', flexDirection: 'column', gap: '8px', fontSize: '0.88rem', color: '#334155', paddingLeft: '20px', margin: 0 }}>
      ...
      {/* Cancellation Policy */}
      <div style={{ marginBottom: '28px', background: '#fffbeb', border: '1.5px solid #fef3c7', padding: '16px', borderRadius: '10px' }}>
        <h3 style={{ fontSize: '0.92rem', fontWeight: 800, color: '#92400e', marginBottom: '4px' }}>
          Cancellation & Termination Policy
        </h3>
        <p style={{ fontSize: '0.86rem', color: '#78350f', margin: 0, lineHeight: 1.6 }}>
      ...
      {/* Action Button Triggering Official Popup Modal */}
      <div style={{ textAlign: 'center', marginTop: '32px' }}>
        <button
          ...
          style={{
            ...
            fontSize: '0.96rem', fontWeight: 900, border: '2px solid #f2b733',
            cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: '10px',
            boxShadow: '0 6px 20px rgba(0,6,72,0.25)', transition: 'transform 0.2s ease'
          }}
          onMouseEnter={(e) => e.currentTarget.style.transform = 'scale(1.03)'}
          onMouseLeave={(e) => e.currentTarget.style.transform = 'scale(1)'}
        >
          <HiShieldCheck size={22} /> Complete Admission Registration
        </button>
      </div>
      ...
      <section className="section" style={{ padding: '56px 0' }}>
        <div className="container" style={{ maxWidth: '920px', margin: '0 auto' }}>
          ...
          {activeTab === 'policy' ? (
            ...
            <AdmissionAgreementTab onOpenDemoModal={onOpenDemoModal} />
          )}
